...
- We want to reconstruct a latent spatial (temporal) surface $\mathbf{S}$ from a finite set of noisy observations and their spatial (temporal) location.
...
.pull-left[
- Good agreement between wastewater prediction and modelled prevalence of the disease

- Potential for data integration

`r include_fig("wwprev_trends_ltla.png", width="80%")`
]

.pull-right[
We consider the use of wastewater data under the following
setting:
`r include_fig("WWCovid.png", width="100%")`
...
.small[Nicholson, George, et al. "Improving local prevalence estimates of SARS-CoV-2 infections using a causal debiasing framework." Nature Microbiology 7.1 (2022): 97-107.]
